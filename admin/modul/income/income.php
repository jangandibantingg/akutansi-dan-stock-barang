						...
						<table border="0" style="width: 800px; ">
						  ...
						  ?>
							<tr>
								...
								<td> &nbsp <a href="modul/income/dellincome.php?id=<?php echo "$o[id_income]";?>"><i class="icon-trash"></i></a> </a> <a href="JavaScript:edit('modul/neraca/neraca_edit.php?id=<?php echo"$o[id_income]";?>');"><i class="icon-edit"></i></a></td>
								</tr>
								<?php } ?>
