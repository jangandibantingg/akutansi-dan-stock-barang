...
?>
        ...
        <div class="row-fluid sortable">
						  ...
						  <fieldset>
							  ...
							  <div class="controls">
								<select name="master"  style="width: 500px; ">
								    ...
								    <?php $k=mysql_query("select * from master,submaster where master.id_master=submaster.id_master and master.status='laba/rugi' order by master.id_master asc ") ;
				...
				<p> berisikan data atau informasi mengenai besarnya laba atau rugi yang dihasilkan dari pendapatan dan besarnya pengeluaran yang terjadi pada periode tertentu.
            	<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header">
						<h2><i class="halflings-icon align-justify"></i><span class="break"></span>income statement  <?php echo "".$iki[1]."-".$iki[0]."  " ?>
						...
						<table border="0" style="width: 800px; ">
						  ...
						  ?>
							<tr>
								...
								<td> &nbsp <a href="modul/income/dellincome.php?id=<?php echo "$o[id_income]";?>"><i class="icon-trash"></i></a> <a><i class="icon-edit"></a></td>
								</tr>
								<?php } ?>
							...
							?>  
                             ...
                             <tr><td style="text-align: right;"><b>saldo awal<b> </td><td style="text-align: right;"><b style="color:green;"><?php echo "$rp_bal"; ?></b></td style="text-align: right;"></tr>	
                             <tr><td style="text-align: right;"><b>saldo akhir<b> </td><td style="text-align: right;"><b style="color:green;"><?php echo "$rp_bal"; ?></b></td style="text-align: right;"></tr>	
							 <tr><td style="text-align: right;"><b>mutasi<b> </td><td style="text-align: right;"><b style="color:green;"><?php echo "$rp_bal"; ?></b></td style="text-align: right;"></tr>								 
							  </tbody>
						 </table>  
